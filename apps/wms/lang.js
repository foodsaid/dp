...
var I18N = {
    ...
    'sync.items_btn': { zh: '\u{1F4E6} 同步物料', en: '\u{1F4E6} Sync Items', th: '\u{1F4E6} ซิงค์สินค้า', my: '\u{1F4E6} ပစ္စည်းချိန်ညှိ' },
    'sync.whs_btn': { zh: '\u{1F3E2} 同步仓库', en: '\u{1F3E2} Sync Warehouses', th: '\u{1F3E2} ซิงค์คลัง', my: '\u{1F3E2} ဂိုဒေါင်ချိန်ညှိ' },
    'sync.bins_btn': { zh: '\u{1F5C3} 同步库位', en: '\u{1F5C3} Sync Bins', th: '\u{1F5C3} ซิงค์ตำแหน่ง', my: '\u{1F5C3} တည်နေရာချိန်ညှိ' },
    'sync.stock_btn': { zh: '\u{1F4C8} 同步库存快照', en: '\u{1F4C8} Sync Snapshot', th: '\u{1F4C8} ซิงค์สแน็ปช็อต', my: '\u{1F4C8} ကုန်ပစ္စည်းချိန်ညှိ' },
    ...
    'oms.search_status': { zh: '状态', en: 'Status', th: 'สถานะ', my: 'အခြေအနေ' },
    ...
    'oms.col_status': { zh: '状态', en: 'Status', th: 'สถานะ', my: 'အခြေအနေ' },
    ...
    'oms.total_records': { zh: '共 {0} 条', en: '{0} records', th: '{0} รายการ', my: '{0} ခု' },
