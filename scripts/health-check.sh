...
monitoring_containers="dp-prometheus dp-alertmanager dp-grafana dp-node-exporter dp-cadvisor dp-pg-exporter dp-redis-exporter-wf dp-redis-exporter-bi"
