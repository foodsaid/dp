...
# 1. favicon: 绝对路径 → 相对路径
sed -i 's|href="/wms/favicon.svg"|href="favicon.svg"|g' "$INDEX"

# 2. 注入 gh-pages 检测标记 (在 </head> 前)
sed -i 's|</head>|    <meta name="gh-pages" content="true">\n</head>|' "$INDEX"

# 3. privacy/terms 链接: 绝对路径 → 相对 .html
sed -i 's|href="/privacy"|href="privacy.html"|g' "$INDEX"
sed -i 's|href="/terms"|href="terms.html"|g' "$INDEX"
...
sed -i 's|href="/wms/favicon.svg"|href="favicon.svg"|g' "$PRIVACY"
sed -i 's|href="/"|href="./"|g' "$PRIVACY"
sed -i 's|__DP_CONTACT_EMAIL__|admin@foodsaid.com|g' "$PRIVACY"

# ============================================================================
# 转换 terms.html
# ============================================================================
TERMS="$OUT/terms.html"
sed -i 's|href="/wms/favicon.svg"|href="favicon.svg"|g' "$TERMS"
sed -i 's|href="/"|href="./"|g' "$TERMS"
sed -i 's|href="/privacy"|href="privacy.html"|g' "$TERMS"
sed -i 's|__DP_CONTACT_EMAIL__|admin@foodsaid.com|g' "$TERMS"
